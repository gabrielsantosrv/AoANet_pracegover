...
class CiderD:
    ...
    """
    def __init__(self, n=4, sigma=6.0, df="corpus", alpha=None, penalize_repetition=False, verbose=False,
                 coefficient_rep=None, coefficient_len=None):
        if verbose:
            print("====CIDER alpha", alpha)
            print("====CIDER coefficient_rep", coefficient_rep)
            print("====CIDER coefficient_len", coefficient_len)
