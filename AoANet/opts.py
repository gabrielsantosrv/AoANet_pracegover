...
def parse_opt():
    ...
    # cider params
    parser.add_argument('--cider_alpha', type=float, default=None,
                        help='alpha of modified cider')
    
    parser.add_argument('--coefficient_rep', type=float, default=None,
                        help='weight to repetition penalty')

    parser.add_argument('--coefficient_len', type=float, default=None,
                        help='weight to length penalty')

    parser.add_argument('--penalize_repetition', type=bool, default=False,
                        help='whether modified cider must penalize repetitions')
    ...
    parser.add_argument('--patience_cider', type=int, default=100000,
                        help='number of epochs of non-improvement on CIDER value in Self-Critical training')
